...
<div class="form-group"> 
									 ...
									 <input type="text" class="form-control" name="discription" id="exampleInputEmail1"> 
									 </div>									 
...
<tr>
  ...
  <td style="text-align:justify;"><img src="images/news/<?php echo $dd; ?>" style="height:100px;width:100px;" /></td> 
  ...
  <td style="text-align:justify;"><?php	echo $f; ?></td> 
        <td><a href="new-delet.php?id=<?php echo $a; ?>" style="color:#fff;"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a></td>
