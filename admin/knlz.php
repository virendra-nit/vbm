       ...
       <div class="content-main">
		...
		<div class="grid-form">
			<div class="grid-form1">
 									<form action="knlz_insert.php" method="post" enctype="multipart/form-data">
...
<tr>
  ...
  <td style="text-align:justify;"><img src="images/knlz/<?php echo $d; ?>" style="height:100px;width:146px;" /></td> 
   <td style="text-align:justify;"><?php	echo $e; ?></td> 
        <td><a href="knlzdel.php?id=<?php echo $a; ?>" style="color:#fff;"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a></td>
